...
class OrderLockingTest extends OrderKernelTestBase {
  ...
  public function testOrderVersionMismatchException() {
    ...
    try {
      ...
      $this->assertEquals('The order has either been modified by another user, or you have already submitted modifications. As a result, your changes cannot be saved.', $e->getMessage());
