...
class KeypadTest extends WebDriverTestBase {
  ...
  public function testInputBoxForm() {
    ...
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[1]/td[2]/input')[0]->setValue(40);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[2]/td[2]/input')[0]->setValue(30);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[3]/td[2]/input')[0]->setValue(20);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[4]/td[2]/input')[0]->setValue(10);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[5]/td[2]/input')[0]->setValue(5);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[6]/td[2]/input')[0]->setValue(4);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[7]/td[2]/input')[0]->setValue(3);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[8]/td[2]/input')[0]->setValue(2);
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[9]/td[2]/input')[0]->setValue(1);

    // Confirm the total value.
    $total_row = $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[11]/td[2]/span')[0];
    $this->assertEquals($total_row->getText(), '15140');

    // Now, click the 'Add' button to add up all the values.
    $this->xpath('//*[@id="commerce-pos-keypad-cash-input-box"]/div/div/div/table/tbody/tr[12]/td[2]/a')[0]->click();

    $this->createScreenshot(\Drupal::root() . '/sites/default/files/simpletest/screen.png');
    file_put_contents(\Drupal::root() . '/sites/default/files/simpletest/output.html', $this->getSession()->getPage()->getHTML());

    // Make sure the correct value has been inserted into the amount field.
    $web_assert->fieldValueEquals('amount', '151.4');
  }
