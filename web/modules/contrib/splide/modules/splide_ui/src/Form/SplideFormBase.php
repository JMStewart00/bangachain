...
abstract class SplideFormBase extends EntityForm {
  ...
  /**
   * Returns the splide admin service.
   */
  ...
  /**
   * Returns the splide manager service.
   */
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes']['class'][] = 'form--blazy form--slick form--splide form--optionset has-tooltip';
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    // Prevent leading and trailing spaces in splide names.
