...
/**
 * Provides the Outstanding Gift Cards Report.
 *
 * @CommerceReportType(
 *   id = "total_inventory",
 *   label = @Translation("Outstanding Gift Cards"),
 *   description = @Translation("Outstanding Gift Cards currently on available.")
 * )
 */
class OutstandingGiftCardReport extends ReportTypeBase {
