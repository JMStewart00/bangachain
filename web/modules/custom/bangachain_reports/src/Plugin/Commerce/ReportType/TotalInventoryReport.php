...
/**
 * Provides the Total Inventory Report.
 *
 * @CommerceReportType(
 *   id = "total_inventory",
 *   label = @Translation("Total Inventory"),
 *   description = @Translation("Total Inventory currently on hand.")
 * )
 */
class TotalInventoryReport extends ReportTypeBase {
